...
const Onboarding = () => {
  ...
  const steps = [
    ...
    { number: 2, title: 'Your Information', description: 'Owner details and account setup' },
    { number: 3, title: 'Warehouse & Payment', description: 'Complete your setup' },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center space-x-2 mb-4">
              ...
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">ProfitPulse</h1>
            </div>
