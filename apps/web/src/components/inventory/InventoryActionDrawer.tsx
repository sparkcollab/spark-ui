            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Select
                    value={
                      formData?.unitOfMeasure || product?.unitOfMeasure || ""
                    }
                    onValueChange={(value) =>
                ...
                <div>
                  <Label htmlFor="subcategory">Cost Price *</Label>
                  <Input
                    id="costPrice"
                    placeholder="Cost Price"
                    value={formData?.costPrice || product?.costPrice || ""}
                    onChange={(e) =>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("quantityReceived", e.target.value)
                    }
                  />
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Select
                  value={formData?.returnLotCode || ""}
                  onValueChange={(value) =>
                    handleInputChange("returnLotCode", value)
                  }
                >
                  <SelectTrigger>
                  ...
                  <SelectContent>
                    <SelectItem value="LOT001">
                      LOT001 - Received 2024-06-10 (45 lbs)
                    </SelectItem>
                    <SelectItem value="LOT002">
                      LOT002 - Received 2024-06-08 (30 lbs)
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("returnReason", value)
                  }
                >
                  <SelectTrigger>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Select
                  value={formData?.stockLotCode || ""}
                  onValueChange={(value) =>
                    handleInputChange("stockLotCode", value)
                  }
                >
                  <SelectTrigger>
                  ...
                  <SelectContent>
                    <SelectItem value="LOT001">
                      LOT001 - Current: 25 lbs
                    </SelectItem>
                    <SelectItem value="LOT002">
                      LOT002 - Current: 20 lbs
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("adjustmentQuantity", e.target.value)
                    }
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("adjustmentReason", value)
                  }
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select reason" />
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("adjustmentNotes", e.target.value)
                  }
                />
              </div>
            </div>
